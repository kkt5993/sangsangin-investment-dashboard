...
for(const file of ['charts','analysis-charts','network-views','sauron-views','trade-views','chain-views','relation-views','decision-ledger','research-store','pdf-text','notebook-pdf','research-notes','geo-views','earnings-views','ownership-views','strategy-cards','calendar-views','satellite-views','dragon-research','dragon-signals','clinical-views','guru-views','dragon-operations','attention-views','company-news','quant-screens','dynamics-views','dynamics-export','relation-discovery','research-dashboard'])vm.runInContext(read('docs/'+file+'.js'),context);
