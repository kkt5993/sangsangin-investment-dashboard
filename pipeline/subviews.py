...
EXPECTED={
 ...
 'risk':['리스크 콕핏','신호등 US·KR','파생·옵션','KOSPI 숏감마','쏠림·신용','CFTC 포지션','파생 Wag-the-Dog','비펀더멘탈 수급'],
 'multiasset':['자산 모니터','패턴 스캐너','자산배분'],
 'pm_weekend':['PM 키 게이지','금리·성장','크로스에셋 속보','CTA 시스템 트렌드','매크로 z-score','다이버전스·실적','기초 매크로 시계열','CFTC 포지션'],
}
GAPS={'위성 현장':'시설별 좌표·검증된 위성 관측 필요','인과·영향 모델':'이벤트와 인과 관계·전파 가중치 필요','Soros 재귀성':'원본 복합 산식과 지수 이익 역사 필요'}
