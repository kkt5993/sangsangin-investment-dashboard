...
PARITY={
 ...
 'iw':('주간 관측·글과 이미지·판단 원장','관측/판단/근거/대응·방향/기간/확신/무효화/재검토·이미지/PDF·백업','29판단 항목·두차트의 팀 계산과 공용 DB 미연결'),
 ...
 'ask_digest':('기간별 추세·테마/종목·모듈요약·근거·질문','자체 시장 수치/RSS·질문/해석/근거/추가확인·첨부/백업','기간별 추세/테마/모듈집계·자동 질의/요약 미연결'),
}
