...
EXPECTED={
 'globe':['국가 교역','기업 국가 탐색','밸류체인 유니버스','위성·지구관측'],
 'dragonglass':['관계 지도','지금 주목','위성사진','기업 상세','시나리오','결정 원장','트리거·촉매','리서치','데이터 소스','현황판','방법론'],
...
GAPS={'위성사진':'22시설 실관측·NASA 전 지구 배경 연결; 고해상도 배경·지명 레이어는 추가 확인 필요','인과·영향 모델':'이벤트와 인과 관계·전파 가중치 필요','Soros 재귀성':'원본 복합 산식과 지수 이익 역사 필요'}
GAPS['비펀더멘탈 수급']='종목·레버리지 ETF AUM·공매도·국내 투자자별 수급 수집 중'
GAPS['밸류체인 유니버스']='53업종·151기업 도시·시총 탐색, 공식 주소 및 기업별 공급·생산·시장 인도·물류 근거 연결; 전체 기업 관계·경쟁우위 근거는 추가 수집 중'
GAPS['위성·지구관측']='시설·지진 스냅샷·SGP4 궤도·3D 카메라·6개 화면 효과 연결; Google 실사3D는 별도 키 필요'
def attach(obj):
