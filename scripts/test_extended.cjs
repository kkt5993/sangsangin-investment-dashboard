...
(async()=>{
 await relationChecks;await overviewChecks;await geoChecks;await earningsChecks;await ownershipChecks;await calendarChecks;await satelliteChecks;await researchChecks;await pdfChecks;
 let count=0;
