...
const ctx=vm.createContext({window:{},console});for(const n of ['charts','analysis-charts','network-views','relation-views','overview-views','research-notes','geo-views'])vm.runInContext(fs.readFileSync(path.join(root,'docs',n+'.js'),'utf8'),ctx);
