...
모듈 요약은 현재 계산 묶음의20개 분석 모듈에서 기준일·주요 값·표의첫2행(최대2표)·방법·남은 범위를 참조한다. ML/통합예측의 별도 기준일을 유지하고 이후 날짜 자료가 끼면 중단한다. 원본 내부 요약이18개인 것과 구분한다. 원본에 없는 분석 내용을 만들어 개수를 채우지 않는다.
