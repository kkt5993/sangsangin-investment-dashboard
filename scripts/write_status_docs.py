...
CODE={
 ...
 'etfmon':'etf_details.py','multiasset':'market_modules.py','dynamics':'market_modules.py · dynamics_model.py · dynamics-views.js · dynamics-export.js','watch':'market_modules.py · patterns.py',
...
CODE['dragonglass']+=' · company_news.py · news_tone.py · company-news.js · entities.py · relation_model.py · relation_views.py · relation_discovery.py · relation-discovery.js'
...
PARITY={
 ...
 'dynamics':('18대상·8룩백×60월표면·36월위상·60월위험/가격·전일노출성과','재생/회전·65음영·4비용 가정·원장CSV·수식/표면PNG·종목링크','21D/5D/expanding252는 팀 파라미터; 결측 뒤 연속 평가·가정 비용이며 실제 체결/PIT 아님'),
