...
def main():
    ...
    budget(len(compressed));(DATA/'expanded'/a.as_of/'local_consensus.json.gz').write_bytes(compressed);print('Imported local consensus',len(f),'rows; snapshot',result['as_of'])
