...
(function(root){
 ...
 function identity(e){const r=e.identity;if(!r)return '';try{const u=new URL(r.identity_source);if(u.protocol!=='https:'||u.username||u.password)return '';return `<p data-entity-identity>공식 종목 확인: <a href="${E(u.href)}" target="_blank" rel="noopener noreferrer">${E(r.identity_name)} ↗</a><br><small>확인 ${E(r.identity_checked_at)} · 거래소/감독기관 종목 식별이며 지수 편입·업종 확정이 아닙니다.</small></p>`;}catch{return '';}}
