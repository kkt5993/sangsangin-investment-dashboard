...
(function(root){
 ...
 function bind(container,d,navigate,selection={}){
  ...
  const companies=box=>box.querySelectorAll('[data-sat-company]').forEach(b=>b.addEventListener('click',()=>navigate('기업 상세',{entity:b.dataset.satCompany,facility:''})));
  ...
  container.querySelectorAll('[data-satellite]').forEach(box=>{
   ...
   box.querySelectorAll('[data-sat-open]').forEach(b=>b.addEventListener('click',()=>navigate('기업 상세',{facility:b.dataset.satOpen})));
