...
**계산·화면 연결** · 가격 기준 2026-09-10. PC 수집→검증→Vercel·평일08/18시 갱신·변경분 캐시.
...
3. 팀 운영은 한국시간 평일08시·18시 PC 수집→검증→Vercel 게시다. pipeline.refresh 명령과변경분 캐시를 사용한다. PC와 Codex 앱이 실행 중이어야 한다.
