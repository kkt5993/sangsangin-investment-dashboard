...
**부분 구현** · 가격 기준 2026-09-08. 미국/한국 금리·물가·유동성 등 5년 패널·단위/최신일.
...
- 계산/자료 계약: 5년 시계열 14개 패널. 월간 YoY는 월간 관측치의 12개월 변화율이며, 주간·일간 데이터를 12개 관측치 변화율로 잘못 계산하지 않습니다. 모든 차트에 서로 다른 단위·축을 표시합니다.
