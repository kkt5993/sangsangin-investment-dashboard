...
for(const file of ['charts','analysis-charts','network-views','decision-ledger','research-store','research-notes','research-dashboard'])vm.runInContext(read('docs/'+file+'.js'),context);
