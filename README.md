...
밸류체인 유니버스는20개 그룹·53개 업종의151기업을 탐색합니다. 업종별 표·기업/도시 선택·회전 지도, 프로필 소재지와 시가총액, 공시로 확인한 공급 관계와 소재국 교역을 표시합니다. [기업 탐색 계약](research/CHAIN_UNIVERSE_CONTRACT.md)에 도시·통화·갱신 주기와 전체 공급/물류 근거의 남은 범위를 기록했습니다.
